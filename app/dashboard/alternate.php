...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `booking` SET `alternate_key`='$status', `employee_alternate` = '$admin_id' WHERE id = $order_id";
    $stmt = $conn->prepare("$sql");
    $executed = $stmt->execute();
    if($executed){
...
if(isset($_GET['del'])){
    ...
    $sql = "UPDATE `booking` SET `alternate_key`='0' WHERE id = $id";
    $stmt = $conn->prepare("$sql");
    $executed = $stmt->execute();
    if($executed){
        $msg = '<div class="alert alert-success" role="alert">
...
$booking = $conn->query("SELECT * FROM `booking` WHERE alternate_key != 0")->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Alternate Key</h1>
                    </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$val['locker_id']?></td>
                      <td><a href="../<?=$val['attachment']?>" class="btn btn-info" target="_blank">Show</a></td>
                      <td><?=status($val['alternate_key'])?></td>
                      <?php if($_SESSION['as'] == "Administrative"): ?>
...
<div class="modal fade" id="exampleModal<?=$val['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Alternate Key for Order <?=$val['id']?></h5>
  ...
  <select name="aprrove" class="form-control">
      <option value="2" id="approve<?=$val['id']?>">Approve</option>
      <option value="1" id="waiting<?=$val['id']?>">Pending</option>
  </select>
  </div>
