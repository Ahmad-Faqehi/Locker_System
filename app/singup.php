...
if(isset($_POST['submit'])){
    ...
    $num_user = $conn->query("select count(*) from  students where username = '$username' ")->fetchColumn();
    ...
    if($password !== $re_password){
      ...
      Username is already used
        ...
        $stmt = $conn->prepare("INSERT INTO `students`(`name`, `phone_number`, `username`, `password`) VALUES ('$fname','$phone_number','$username','$password')");
...
<input type="text" name="fname" id="cname" class="wi-control">
</div>
</div>
<div class="col-md-12">
<div class="wepaint-input-group">
<label for="cname">Phone Number</label>
<input type="number" name="number" id="cname" class="wi-control">
</div>
</div>
<div class="col-md-12">
<div class="wepaint-input-group">
...
<input type="password" name="Re_password" id="cntryname" class="wi-control">
</div>
</div>
